	...
	val recipe = Recipe(
		...
		tasks = listOf(
			...
			CookingTask(
				...
				resources = uses(COOK, PAN, BURNER),
				instruction = "Rozbi 2 vajcia priamo do panvice k cibuli, hneď ich osol malou štipkou soli a začni miešať. Stiahni na stredne nízky výkon. Keď už vajcia nie sú tekuté, ale stále sú mäkké a trochu lesklé, daj panvicu zo sporáka a až vtedy potvrď HOTOVO.",
				tips = listOf(
